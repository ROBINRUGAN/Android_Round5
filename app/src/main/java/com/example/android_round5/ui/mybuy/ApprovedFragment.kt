...
import com.example.android_round5.databinding.FragmentApprovedBinding
    ...
    override fun onCreateView(
        ...
        javaAppService.GetMyBuy().enqueue(object: Callback<OrderList> {
            override fun onResponse(call: Call<OrderList>, response: Response<OrderList>) {
                ...
                mybuyAdapter = MyBuyAdapter(filteredOrders, this@ApprovedFragment)
                binding.recyclerViewApprovedOrders.adapter = mybuyAdapter
                binding.recyclerViewApprovedOrders.layoutManager = LinearLayoutManager(requireContext())
            }

...
import com.example.android_round5.databinding.FragmentAdminGoodAllBinding
import com.example.android_round5.databinding.FragmentAdminGoodUnconfirmedBinding
...
class AdminGoodUnconfirmedFragment : Fragment() {
    private var _binding: FragmentAdminGoodUnconfirmedBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdminGoodUnconfirmedBinding.inflate(inflater, container, false)
        //******************************************************************************************
        ...
        appService.AdminGetGood().enqueue(object: Callback<HomeList> {
            override fun onResponse(call: Call<HomeList>, response: Response<HomeList>) {
                ...
                adminGoodAdapter = AdminItemAdapter(filteredOrders,this@AdminGoodUnconfirmedFragment)
                binding.adminRecyclerViewUnconfirmedGoods.adapter = adminGoodAdapter
                val layoutManager = GridLayoutManager(requireContext(), 2)
                binding.adminRecyclerViewUnconfirmedGoods.layoutManager = layoutManager
            }

...
import com.example.android_round5.databinding.SellFragmentUnpaidBinding
...
class SellUnpaidFragment : Fragment() {
    private var _binding: SellFragmentUnpaidBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = SellFragmentUnpaidBinding.inflate(inflater, container, false)
        //******************************************************************************************

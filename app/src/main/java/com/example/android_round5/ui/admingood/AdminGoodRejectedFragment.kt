...
import com.example.android_round5.databinding.FragmentAdminGoodRejectedBinding
...
class AdminGoodRejectedFragment : Fragment() {
    private var _binding: FragmentAdminGoodRejectedBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdminGoodRejectedBinding.inflate(inflater, container, false)
        //******************************************************************************************
        ...
        appService.AdminGetGood().enqueue(object: Callback<HomeList> {
            override fun onResponse(call: Call<HomeList>, response: Response<HomeList>) {
                ...
                adminGoodAdapter = AdminItemAdapter(filteredOrders,this@AdminGoodRejectedFragment)
                binding.adminRecyclerViewRejectedGoods.adapter = adminGoodAdapter
                val layoutManager = GridLayoutManager(requireContext(), 2)
                binding.adminRecyclerViewRejectedGoods.layoutManager = layoutManager
            }

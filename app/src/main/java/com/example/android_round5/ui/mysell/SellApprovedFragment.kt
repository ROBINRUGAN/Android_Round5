...
import com.example.android_round5.databinding.SellFragmentApprovedBinding
...
class SellApprovedFragment : Fragment() {
    private var _binding: SellFragmentApprovedBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = SellFragmentApprovedBinding.inflate(inflater, container, false)
        //******************************************************************************************
        ...
        javaAppService.GetMySell().enqueue(object: Callback<OrderList> {
            override fun onResponse(call: Call<OrderList>, response: Response<OrderList>) {
                ...
                mySellAdapter = MySellAdapter(filteredOrders, this@SellApprovedFragment)
                binding.sellRecyclerViewApprovedOrders.adapter = mySellAdapter
                binding.sellRecyclerViewApprovedOrders.layoutManager = LinearLayoutManager(requireContext())
            }

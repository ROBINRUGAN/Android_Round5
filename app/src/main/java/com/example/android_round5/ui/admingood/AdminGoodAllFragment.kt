...
class AdminGoodAllFragment : Fragment() {
    private var _binding: FragmentAdminGoodAllBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAdminGoodAllBinding.inflate(inflater, container, false)
        //******************************************************************************************
        ...
        appService.AdminGetGood().enqueue(object: Callback<HomeList> {
            override fun onResponse(call: Call<HomeList>, response: Response<HomeList>) {
                ...
                adminGoodAdapter = AdminItemAdapter(orders,this@AdminGoodAllFragment)
                binding.adminRecyclerViewAllGoods.adapter = adminGoodAdapter
                val layoutManager = GridLayoutManager(requireContext(), 2)
                binding.adminRecyclerViewAllGoods.layoutManager = layoutManager

...
import com.example.android_round5.databinding.SellFragmentRejectedBinding
...
class SellRejectedFragment : Fragment() {
    private var _binding: SellFragmentRejectedBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = SellFragmentRejectedBinding.inflate(inflater, container, false)
        //******************************************************************************************

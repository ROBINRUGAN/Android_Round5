...
import com.example.android_round5.MyFavoriteActivity
 ...
 * @author MEWWW
 */
class OtherItemAdapter(val homeItemList: ArrayList<HomeData>, val activity: Activity) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        Glide.with(this.activity).load(firstUrl).into(holder.image)
        Glide.with(this.activity).load(homeItem.seller_profile_photo).into(holder.avatar)
